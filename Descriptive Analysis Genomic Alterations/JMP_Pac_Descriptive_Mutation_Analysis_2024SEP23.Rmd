---
title: "Descriptive Analysis on Geneomic Alterations in 120 JMP_Pac Patients"
...
```{r Microsatellite Instability (MSI) table, echo=FALSE}
  ...
  mut_table %>%
    ...
    tab_footnote(
      footnote = paste('Fisher test p-value = ',signif(fisher.test(mut_table$MASLD25,mut_table$result_group)$p.value, digits = 3))
      )
```
